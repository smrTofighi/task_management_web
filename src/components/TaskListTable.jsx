                ...
                {tableData.map((task)=>(
                    <tr key={task._id} className='border-t border-gray-200'>
                        ...
                        <td className='py-4 px-4'>
                            <span className={`px-2 py-1 text-xs rounded inline-block ${getStatusBadgeColor(task.status)}`}>{statusMap[task.status]}</span>
                        </td>
                        <td className='py-4 px-4'>
                            <span className={`px-2 py-1 text-xs rounded inline-block ${getPriorityBadgeColor(task.priority)}`}>{priorityMap[task.priority]}</span>
                        </td>
